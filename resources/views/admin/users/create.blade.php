        ...
        <div class="admin-page-header-content">
            <div>
                <div class="admin-breadcrumb mb-2">
                    ...
                    <span class="admin-breadcrumb-current">Create New User</span>
                </div>
                <h2 class="admin-page-title">Create New User</h2>
            ...
            <div class="col-lg-8">
                ...
                <div class="admin-form-section-card mb-4">
                    <div class="admin-form-section-header">
                        ...
                        <div>
                            <h5 class="admin-form-section-title">Security</h5>
                            <p class="admin-form-section-subtitle">Password and authentication</p>
                        </div>
                    </div>
                    <div class="admin-form-section-body">
                        <div class="admin-form-group">
                            ...
                            <input type="password" class="admin-form-input @error('password') is-invalid @enderror"
                                name="password" required placeholder="Enter secure password">
                        ...
                        <div class="admin-form-group">
                            ...
                            <input type="password" class="admin-form-input" name="password_confirmation" required
            ...
            <div class="col-lg-4">
                    ...
                    <div class="admin-settings-card-body">
                        <div class="admin-form-group">
                            ...
                            <select class="admin-form-select @error('role') is-invalid @enderror" name="role" required>
                                ...
                                <option value="business_owner" {{ old('role') === 'business_owner' ? 'selected' : '' }}>
                        ...
                        <div class="admin-toggle-setting mt-3">
                            <div class="admin-toggle-info">
                                <strong>Auto-Verify Email</strong>
                                <span>Skip email verification process</span>
                            </div>
                            <label class="admin-toggle-switch">
                                <input type="checkbox" name="auto_verify" value="1"
                                    {{ old('auto_verify', 0) ? 'checked' : '' }}>
                                <span class="admin-toggle-slider"></span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="admin-info-card">
                    ...
                    <div class="admin-info-card-body">
                        <div class="admin-role-description">
                            <div class="admin-role-description-icon user">
                                <i class='bx bx-user'></i>
                            </div>
                            <div>
                                <strong>User</strong>
                                <p>Can browse, review attractions, and submit suggestions</p>
                            </div>
                        </div>

                        <div class="admin-role-description">
                            <div class="admin-role-description-icon business">
                                <i class='bx bx-store'></i>
                            </div>
                            <div>
                                <strong>Business Owner</strong>
                                <p>Can manage their business profile and promotions</p>
                            </div>
                        </div>

                        <div class="admin-role-description">
                            <div class="admin-role-description-icon admin">
                                <i class='bx bx-shield'></i>
                            </div>
                            <div>
                ...
                <!-- Actions -->
                <div class="admin-action-final-card mt-4">
                    <div class="admin-action-final-body">
                        <button type="submit" class="admin-submit-btn primary">
                            <i class='bx bx-check-circle'></i>
                            <span>Create User</span>
                        </button>
                        <a href="{{ route('admin.users.index') }}" class="admin-submit-btn secondary">
                            <i class='bx bx-x'></i>
                            <span>Cancel</span>
                        </a>
                    </div>
...
@push('styles')
    <style>
        ...
        .admin-role-description:last-child {
            margin-bottom: 0;
        }

        .admin-role-description-icon {
            width: 40px;
            height: 40px;
            border-radius: 8px;
            display: flex;
        ...
        .admin-role-description-icon.user {
            background: linear-gradient(135deg, #64748b, #475569);
        }

        .admin-role-description-icon.business {
            background: linear-gradient(135deg, #00A8E8, #0284c7);
        }

        .admin-role-description-icon.admin {
            background: linear-gradient(135deg, #dc2626, #b91c1c);
        }

        .admin-role-description strong {
            display: block;
            font-size: 0.9375rem;
            color: #1e293b;
            margin-bottom: 0.25rem;
