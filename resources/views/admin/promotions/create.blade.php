        ...
        <div class="admin-page-header-content">
            <div>
                <div class="admin-breadcrumb mb-2">
                    ...
                    <span class="admin-breadcrumb-current">Create New</span>
                </div>
                <h2 class="admin-page-title">Create Promotion</h2>
                <p class="admin-page-subtitle">Set up a new promotional campaign</p>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="admin-form-section-card mb-4">
                    ...
                    <div class="admin-form-section-body">
                        <div class="admin-form-group">
                            ...
                            <select class="admin-form-select @error('promotable_type') is-invalid @enderror"
                                ...
                                <option value="App\Models\Attraction"
                                    {{ old('promotable_type') == 'App\Models\Attraction' ? 'selected' : '' }}>
                                    Attraction
                                </option>
                                <option value="App\Models\Business"
                                    {{ old('promotable_type') == 'App\Models\Business' ? 'selected' : '' }}>
                                    Business
                                </option>
                            </select>
                        ...
                        <div class="admin-form-group" id="attraction_select" style="display: none;">
                            <label class="admin-form-label">
                        ...
                        <div class="admin-form-group" id="business_select" style="display: none;">
                            <label class="admin-form-label">
                ...
                <div class="admin-form-section-card mb-4">
                    <div class="admin-form-section-header">
                        ...
                        <div>
                            ...
                            <p class="admin-form-section-subtitle">Add title, description and dates</p>
                        </div>
                    </div>
                    <div class="admin-form-section-body">
                        <div class="admin-form-group">
                        ...
                        <div class="admin-form-group">
                            ...
                            <textarea class="admin-form-textarea @error('description') is-invalid @enderror" id="description" name="description"
                                rows="5" placeholder="Describe your promotion in detail..." required>{{ old('description') }}</textarea>
                            @error('description')
                                <div class="admin-form-error">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="admin-form-section-card mb-4">
                    <div class="admin-form-section-header">
                        ...
                        <div>
                            <h5 class="admin-form-section-title">Promotion Image</h5>
                            <p class="admin-form-section-subtitle">Upload an eye-catching visual</p>
                        </div>
                    </div>
                    <div class="admin-form-section-body">
                        <div class="admin-form-group">
                    ...
                    <div class="admin-sidebar-card">
                        <div class="admin-sidebar-card-body">
                            <div class="admin-form-actions">
                                ...
                                <a href="{{ route('admin.promotions.index') }}" class="admin-submit-btn secondary">
                                    <i class='bx bx-x'></i>
                                    <span>Cancel</span>
                                </a>
                            </div>
...
@push('styles')
    <style>
        ...
        .admin-image-preview-container img {
            width: 100%;
            border-radius: 12px;
...
@push('scripts')
    <script>
        ...
        // Set promotable_id based on selection
        document.querySelector('form').addEventListener('submit', function(e) {
            const type = document.getElementById('promotable_type').value;
            const attractionId = document.getElementById('attraction_id').value;
            const businessId = document.getElementById('business_id').value;

            // Create hidden input for promotable_id
            const hiddenInput = document.createElement('input');
            hiddenInput.type = 'hidden';
            hiddenInput.name = 'promotable_id';

            if (type === 'App\\Models\\Attraction') {
                hiddenInput.value = attractionId;
            } else if (type === 'App\\Models\\Business') {
        ...
        window.addEventListener('load', function() {
            const promotableType = document.getElementById('promotable_type');
            if (promotableType.value) {
                promotableType.dispatchEvent(new Event('change'));
            }
        });
