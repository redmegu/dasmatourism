...
@section('page-title', 'Edit Story Chapter')
...
@section('content')
    ...
    <div class="admin-form-header mb-4">
        <div class="admin-form-header-content">
            <div>
                <a href="{{ route('admin.story-chapters.show', $storyChapter) }}" class="admin-breadcrumb-link">
                    <i class='bx bx-chevron-left'></i> Back to Chapter
                </a>
                <h2 class="admin-form-title">Edit Story Chapter</h2>
                <p class="admin-form-subtitle">Chapter {{ $storyChapter->chapter_number }}: {{ $storyChapter->title }}</p>
            </div>
    ...
    <form action="{{ route('admin.story-chapters.update', $storyChapter) }}" method="POST" enctype="multipart/form-data"
        id="chapterForm">
        @csrf
        @method('PUT')
            ...
            <div class="col-lg-8">
                    ...
                    <div class="admin-form-card-body">
                        <div class="admin-form-row">
                            <div class="admin-form-col" style="flex: 0 0 150px;">
                                ...
                                <input type="number" class="admin-form-input @error('chapter_number') is-invalid @enderror"
                                    id="chapter_number" name="chapter_number"
                                    value="{{ old('chapter_number', $storyChapter->chapter_number) }}" required
                                    min="1">
                            ...
                            <div class="admin-form-col" style="flex: 1;">
                                ...
                                <input type="text" class="admin-form-input @error('title') is-invalid @enderror"
                                    id="title" name="title" value="{{ old('title', $storyChapter->title) }}" required
                        ...
                        <div class="admin-form-group">
                            ...
                            <textarea class="admin-form-textarea-large @error('content') is-invalid @enderror" id="content" name="content"
                                rows="12" required placeholder="Write your story content here...">{{ old('content', $storyChapter->content) }}</textarea>
                            ...
                            <select class="admin-form-select @error('attraction_id') is-invalid @enderror"
                                ...
                                @foreach ($attractions as $attraction)
                                    <option value="{{ $attraction->id }}"
                                        {{ old('attraction_id', $storyChapter->attraction_id) == $attraction->id ? 'selected' : '' }}>
                                        {{ $attraction->name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                @if ($storyChapter->background_image)
                    <div class="admin-form-card">
                        <div class="admin-form-card-header">
                            ...
                            <div>
                                <h5 class="admin-form-card-title">Current Background</h5>
                                <p class="admin-form-card-subtitle">Active chapter background image</p>
                            </div>
                        </div>
                        <div class="admin-form-card-body">
                            <div class="admin-current-image-preview">
                                <img src="{{ asset('storage/' . $storyChapter->background_image) }}"
                                    alt="{{ $storyChapter->title }}">
                                <div class="admin-current-image-badge">
                ...
                <div class="admin-form-card">
                    <div class="admin-form-card-header">
                        ...
                        <div>
                            <h5 class="admin-form-card-title">
                                {{ $storyChapter->background_image ? 'Change Background' : 'Add Background' }}
                            </h5>
                            <p class="admin-form-card-subtitle">
                                {{ $storyChapter->background_image ? 'Upload a new image to replace current' : 'Upload background image' }}
                            </p>
                        </div>
                    </div>
                    <div class="admin-form-card-body">
                        <div class="admin-upload-area">
                            <input type="file" class="admin-upload-input" id="background_image"
                            ...
                            <label for="background_image" class="admin-upload-label">
                                ...
                                <div class="admin-upload-text">
                                    <span class="admin-upload-title">Click to upload new image</span>
                        ...
                        <div class="admin-form-help">
                            ...
                            {{ $storyChapter->background_image ? 'Leave empty to keep current image' : 'This image will be displayed as the chapter background' }}
                        </div>
                ...
                @if ($storyChapter->visual_images && count($storyChapter->visual_images) > 0)
                    <div class="admin-form-card">
                        <div class="admin-form-card-header">
                            ...
                            <div>
                                <h5 class="admin-form-card-title">Current Visual Images</h5>
                                <p class="admin-form-card-subtitle">Active character/scene images</p>
                            </div>
                        </div>
                        <div class="admin-form-card-body">
                            <div class="admin-visual-images-grid">
                                @foreach ($storyChapter->visual_images as $index => $visualImage)
                                    <div class="visual-image-item">
                                        <img src="{{ asset('storage/' . $visualImage) }}"
                                            alt="Visual {{ $index + 1 }}">
                                        <div class="visual-image-label">
                                            <i class='bx bx-check-circle'></i> Image {{ $index + 1 }}
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            <div class="admin-form-help mt-3">
                                <i class='bx bx-info-circle'></i> Uploading new images below will replace all existing
                                visual
                                images
                            </div>
                        </div>
                ...
                <div class="admin-form-card">
                    <div class="admin-form-card-header">
                        ...
                        <div>
                            <h5 class="admin-form-card-title">
                                {{ $storyChapter->visual_images && count($storyChapter->visual_images) > 0 ? 'Change Visual Images' : 'Add Visual Images' }}
                            </h5>
                            <p class="admin-form-card-subtitle">
                                {{ $storyChapter->visual_images && count($storyChapter->visual_images) > 0 ? 'Upload new character/scene images' : 'Upload visual novel images' }}
                            </p>
                        </div>
                    </div>
                    <div class="admin-form-card-body">
                        ...
                        <div class="admin-form-help">
                            <i class='bx bx-info-circle'></i>
                            {{ $storyChapter->visual_images && count($storyChapter->visual_images) > 0 ? 'Leave empty to keep current visual images. Click X to remove before uploading.' : 'Upload character poses or scene illustrations for visual novel style' }}
                        </div>
                        @error('visual_images.*')
                            <div class="admin-form-error">
                                <i class='bx bx-error-circle'></i> {{ $message }}
                        ...
                        <div id="visual-images-preview" class="admin-visual-images-grid-new"></div>
                    </div>
                </div>

                <!-- Current Character Models -->
                @if ($storyChapter->character_models && count($storyChapter->character_models) > 0)
                    <div class="admin-form-card">
                        <div class="admin-form-card-header">
                            ...
                            <div>
                                <h5 class="admin-form-card-title">Current Character Models</h5>
                                <p class="admin-form-card-subtitle">Currently uploaded full-body sprites</p>
                            </div>
                        </div>
                        <div class="admin-form-card-body">
                            <div class="admin-visual-images-grid">
                                @foreach ($storyChapter->character_models as $index => $characterModel)
                                    <div class="visual-image-item">
                                        <img src="{{ asset('storage/' . $characterModel) }}"
                                            alt="Character {{ $index + 1 }}">
                                        <div class="visual-image-label">
                                            <i class='bx bx-check-circle'></i> Character {{ $index + 1 }}
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            <div class="admin-form-help mt-3">
                                <i class='bx bx-info-circle'></i> Uploading new character models below will replace all
                                existing
                                character models
                            </div>
                        </div>
                ...
                <div class="admin-form-card">
                    <div class="admin-form-card-header">
                        ...
                        <div>
                            <h5 class="admin-form-card-title">
                                {{ $storyChapter->character_models && count($storyChapter->character_models) > 0 ? 'Change Character Models' : 'Add Character Models' }}
                            </h5>
                            <p class="admin-form-card-subtitle">
                                {{ $storyChapter->character_models && count($storyChapter->character_models) > 0 ? 'Upload new full-body sprites' : 'Upload character models' }}
                            </p>
                        </div>
                    </div>
                    <div class="admin-form-card-body">
                        ...
                        <div class="admin-form-help">
                            <i class='bx bx-info-circle'></i>
                            {{ $storyChapter->character_models && count($storyChapter->character_models) > 0 ? 'Leave empty to keep current character models. Click X to remove before uploading.' : 'Upload full-body character sprites that will appear outside the main story frame' }}
                        </div>
                        ...
                        <div id="character-models-preview" class="admin-visual-images-grid-new"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                        ...
                        <div class="admin-toggle-item">
                            ...
                            <label class="admin-toggle-switch">
                                <input type="checkbox" id="is_active" name="is_active" value="1"
                                    {{ old('is_active', $storyChapter->is_active) ? 'checked' : '' }}>
                ...
                <div class="admin-form-card">
                    <div class="admin-form-card-header">
                        ...
                        <div>
                            <h5 class="admin-form-card-title">Statistics</h5>
                            <p class="admin-form-card-subtitle">Chapter metrics</p>
                        </div>
                    </div>
                    <div class="admin-form-card-body">
                        <div class="admin-stats-list-compact">
                            <div class="admin-stat-item-compact">
                                <div class="admin-stat-icon-compact">
                                    <i class='bx bx-git-branch'></i>
                                </div>
                                <div>
                                    <label>Story Choices</label>
                ...
                <div class="admin-form-actions">
                    ...
                    <a href="{{ route('admin.story-chapters.show', $storyChapter) }}" class="admin-form-btn secondary">
                        <i class='bx bx-x'></i>
                        <span>Cancel</span>
                    </a>
                </div>
...
@push('styles')
    <style>
        /* [Copy all styles from your original - they're too long to include here] */
        /* Add these NEW styles for remove button: */
        ...
        /* Reuse form styles from create page */
        .admin-form-header {
        ...
        /* New Visual Images Preview */
        .admin-visual-images-grid-new {
            display: grid;
            grid-template-columns: repeat(auto-fill, minmax(180px, 1fr));
            gap: 1.25rem;
            margin-top: 1.5rem;
        ...
        .visual-image-item-new:hover {
            transform: translateY(-4px);
            box-shadow: 0 8px 20px rgba(26, 120, 56, 0.3);
        }


        .visual-image-item-new img {
            width: 100%;
            height: 220px;
            object-fit: cover;
            display: block;
        ...
        /* Keep ALL your existing styles and add the above */
    </style>
@endpush
                ...
                if (e.target.files && e.target.files[0]) {
                    ...
                    reader.onload = function(e) {
                        ...
                        container.style.cssText =
                            'margin-top: 1.5rem; padding: 1rem; background: #f0fdf4; border-radius: 12px; border: 2px solid #1a7838;';

                        const label = document.createElement('p');
                        label.style.cssText =
                            'font-weight: 700; color: #1a7838; margin-bottom: 0.75rem; display: flex; align-items: center; gap: 0.5rem;';
                        label.innerHTML = '<i class="bx bx-check-circle"></i> New Image Preview';

                        const img = document.createElement('img');
                        img.src = e.target.result;
                        img.alt = 'Preview';
                        img.style.cssText =
                            'max-width: 100%; height: auto; border-radius: 10px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);';
            ...
            function renderVisualImages() {
                ...
                selectedFiles.forEach((file, index) => {
                    ...
                    reader.onload = function(e) {
                        ...
                        div.className = 'visual-image-item-new';
                        ...
                        div.innerHTML = `
                            ...
                            <div class="visual-image-label-new">
                                <i class='bx bx-image-add'></i> New Image ${index + 1}
                            </div>
                        `;
                ...
                selectedCharacterFiles.forEach((file, index) => {
                    ...
                    reader.onload = function(e) {
                        ...
                        div.innerHTML = `
                            ...
                            <div class="visual-image-label-new">
                                <i class='bx bx-body'></i> New Character ${index + 1}
                            </div>
                        `;
