        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h3 class="text-white mb-2 fw-bold">
                    <i class='bx bxs-edit me-2'></i>Edit Announcement
                </h3>
                <p class="text-white-50 mb-0">Update and modify your announcement details</p>
            </div>
                ...
                <div
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" name="title"
                            id="title" required value="{{ old('title', $announcement->title) }}"
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror" name="content" id="content" rows="6"
                            ...
                            onfocus="this.style.borderColor='#667eea'" onblur="this.style.borderColor='#e2e8f0'">{{ old('content', $announcement->content) }}</textarea>
                        @error('content')
                            <div class="invalid-feedback" style="display: flex; align-items: center; margin-top: 0.5rem;">
                                <i class='bx bx-error-circle me-1'></i>{{ $message }}
                            </div>
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        @if ($announcement->image)
                            <div style="margin-bottom: 1rem; position: relative; display: inline-block;">
                                <img src="{{ asset('storage/' . $announcement->image) }}" alt="Current Announcement Photo"
                                    style="width: 200px; height: 120px; object-fit: cover; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                                <div
                                    style="position: absolute; top: 0.5rem; right: 0.5rem; background: rgba(239, 68, 68, 0.9); color: white; padding: 0.25rem 0.5rem; border-radius: 6px; font-size: 0.75rem; font-weight: 600;">
                                    <i class='bx bx-image'></i> Current
                                </div>
                            </div>
                            <div style="margin-bottom: 0.75rem;">
                                <small style="color: #64748b; display: flex; align-items: center;">
                                    <i class='bx bx-info-circle me-1'></i>Upload a new image to replace the current one
                                </small>
                            </div>
                        @endif
                    ...
                    <div style="margin-bottom: 2rem;">
                        ...
                        <small style="color: #64748b; display: block; margin-top: 0.5rem;">
                            ...
                            @if ($announcement->published_at)
                                Currently published since {{ $announcement->published_at->format('M d, Y h:i A') }}
                            @else
                                This announcement is not yet published
                            @endif
                        </small>
                    </div>
